/// @description bhpg_pattern_init(number of bullets, bullet spread, start angle, total arrays, array spread, begin spin speed, spin change rate, spin reverse, max spin speed, fire rate, object width,object height,x offset,y offset)
/// @function bhpg_pattern_init
/// @param number of bullets
/// @param  bullet spread
/// @param  start angle
/// @param  total arrays
/// @param  array spread
/// @param  begin spin speed
/// @param  spin change rate
/// @param  spin reverse
/// @param  max spin speed
/// @param  fire rate
/// @param  object width
/// @param object height
/// @param x offset
